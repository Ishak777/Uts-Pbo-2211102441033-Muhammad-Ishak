...
public class SnakeHead extends Actor
{
    ...
    public void act(){
        ...
        if (facingEdge())
        {
            gameOver(); // Panggil metode gameOver jika ular menabrak tembok
        }
    }
    private void gameOver()
    {
        // Tambahkan logika untuk menangani saat game over di sini
        // Misalnya, hentikan permainan atau tampilkan pesan game over
